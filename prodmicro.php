				...
				<span class="icon-bar"></span>
						...
						<div class="logo-w3layouts-agileits">
							<h1> <a class="navbar-brand" href="index.php">
                                    <img src="images/logoaavie.png" alt="" width="290" height="60">
                                </a></h1>
						</div>
					</div>
						...
						<div class="nav_right_top">
							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown active">
									...
									<ul class="dropdown-menu">
										<li><a href="prodind.php">Produits Individuels</a></li>
										<li><a href="prodbanc.php">Produits Bancassurances</a></li>
										<li><a href="prodmicro.php">Produits Microassurances</a></li>
									</ul>
								</li>
	...
	<div class="services-breadcrumb">
		<div class="inner_breadcrumb">
			...
			<ul class="short">
				...
				<li>Produits Micro assurances</li>
			</ul>
		</div>
	</div>
	<!--//banner_info-->
